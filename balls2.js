...
class circle{
	...
	run(){
		...
		//this.vy*=0.98;
		//this.vx*=0.98;
		if(this.x+this.r>=700||this.x-this.r<=0){this.vx=-0.8*this.vx;this.vy=0.8*this.vy;}
		if(this.y+this.r>=700||this.y-this.r<=0){this.vy=-0.8*this.vy;this.vx=0.8*this.vx;}
